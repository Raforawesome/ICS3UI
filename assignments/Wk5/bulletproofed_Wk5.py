...
while mode == "":
	...
	try:
		...
		print("EOF Error, please try again")
		continue
	if choice == "1":
		mode = res
	elif choice == "2":
...
# add a graphic
# check if wrench-downscaled.png exists
# if it does, use it
# if not, use the default
wrench: Surface | Rect | None = None
try:
	wrench = pygame.image.load('wrench-downscaled.png')
except FileNotFoundError:
	wrench = pygame.rect.Rect(0, 0, screen.get_width() // 8, screen.get_height() // 8)
